...
class bootGame extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.audio("a_sound", ["assets/sounds/enamel_paint.mp3"]);


        this.load.audio("enamel_paint", ["assets/sounds/enamel_paint.mp3"]);

        this.load.audio("animal_paint", ["assets/sounds/animal_paint.mp3"]);
...
class playGame extends Phaser.Scene{
    ...
    this.enamal_paint = this.sound.add("enamal_paint");
